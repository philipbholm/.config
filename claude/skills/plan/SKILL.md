...
allowed-tools: Read, Glob, Grep, Bash(git *), Bash(ls *), Bash(mkdir *), Task, Write(/Users/philip/vaults/work/dev/*), Write(/Users/philip/.claude/plans/*), Edit(/Users/philip/.claude/plans/*), AskUserQuestion, EnterPlanMode, ExitPlanMode
---
...
All plans are stored in `~/vaults/work/dev/{repo}/issues/{NNN}-{branch}/PLAN-{seq}.md`.
...
1. Output the full absolute path to the plan file (e.g., `/Users/philip/vaults/work/dev/ledidi-monorepo/issues/003-update-registry-cards/PLAN-01.md`). Never output just the filename or a relative path.
