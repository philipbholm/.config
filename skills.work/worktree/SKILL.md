---
name: worktree
description: Coordinate branch ownership before editing a Ledidi checkout, and create, enter, or remove Ledidi worktrees.
---
...
not an enforced lock. Record starting HEAD and existing task-owned changes.
Before implementing shared behavior, inspect known related branches or PRs
that touch it and identify which branch owns the change. Before committing,
recheck HEAD and inspect intervening changes from another session.
